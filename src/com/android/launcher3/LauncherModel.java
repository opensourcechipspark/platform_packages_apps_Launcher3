...
public class LauncherModel extends BroadcastReceiver {
    ...
    private class LoaderTask implements Runnable {
        ...
        private boolean loadWorkspace() {
			...
			mDisplay_auto_enable=RkSystemProp.getInt("persist.sys.displayauto.enable",0);
			//Log.d(TAG,"loadWorkspace:mDisplay_auto_enable="+mDisplay_auto_enable);
    ...
    public ShortcutInfo getShortcutInfo(PackageManager manager, Intent intent, Context context,
        ...
        ComponentName componentName = intent.getComponent();
        final ShortcutInfo info = new ShortcutInfo();
		//modify by huangjc:we don't need to check PackageComponent again
